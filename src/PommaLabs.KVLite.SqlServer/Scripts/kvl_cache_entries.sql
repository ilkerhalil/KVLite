...
CREATE TABLE [kvl_cache_entries] (
    ...
    CONSTRAINT [uk_kvle] UNIQUE ([kvle_hash] ASC)
...
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Optional parent entry, used to link entries in a hierarchical way.', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'kvl_cache_entries', @level2type = N'COLUMN', @level2name = N'kvle_parent_key0';
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Optional parent entry, used to link entries in a hierarchical way.', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'kvl_cache_entries', @level2type = N'COLUMN', @level2name = N'kvle_parent_key1';
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Optional parent entry, used to link entries in a hierarchical way.', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'kvl_cache_entries', @level2type = N'COLUMN', @level2name = N'kvle_parent_key2';
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Optional parent entry, used to link entries in a hierarchical way.', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'kvl_cache_entries', @level2type = N'COLUMN', @level2name = N'kvle_parent_key3';
EXECUTE sp_addextendedproperty @name = N'MS_Description', @value = 'Optional parent entry, used to link entries in a hierarchical way.', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'TABLE', @level1name = N'kvl_cache_entries', @level2type = N'COLUMN', @level2name = N'kvle_parent_key4';
