...
CREATE TABLE [kvl_cache_entries] (
    ...
    CONSTRAINT [fk_kvle_parent1] FOREIGN KEY ([kvle_partition], [kvle_parent_key1]) REFERENCES [kvl_cache_entries]([kvle_partition], [kvle_key]),
    CONSTRAINT [fk_kvle_parent2] FOREIGN KEY ([kvle_partition], [kvle_parent_key2]) REFERENCES [kvl_cache_entries]([kvle_partition], [kvle_key]),
    CONSTRAINT [fk_kvle_parent3] FOREIGN KEY ([kvle_partition], [kvle_parent_key3]) REFERENCES [kvl_cache_entries]([kvle_partition], [kvle_key]),
    CONSTRAINT [fk_kvle_parent4] FOREIGN KEY ([kvle_partition], [kvle_parent_key4]) REFERENCES [kvl_cache_entries]([kvle_partition], [kvle_key])
);
...
CREATE INDEX [fk_kvle_parent0] ON [kvl_cache_entries] ([kvle_partition], [kvle_parent_key0]);
CREATE INDEX [fk_kvle_parent1] ON [kvl_cache_entries] ([kvle_partition], [kvle_parent_key1]);
CREATE INDEX [fk_kvle_parent2] ON [kvl_cache_entries] ([kvle_partition], [kvle_parent_key2]);
CREATE INDEX [fk_kvle_parent3] ON [kvl_cache_entries] ([kvle_partition], [kvle_parent_key3]);
CREATE INDEX [fk_kvle_parent4] ON [kvl_cache_entries] ([kvle_partition], [kvle_parent_key4]);
