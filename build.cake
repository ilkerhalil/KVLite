...
private void Test(string cfg)
{
    ...
    if (AppVeyor.IsRunningOnAppVeyor)
    {
        ...
        flags += " --postgresql \"Server=127.0.0.1;Port=5432;Database=postgres;User Id=postgres;Password=Password12!;Pooling=true;MinPoolSize=1;Enlist=false;SslMode=Disable;\"";
