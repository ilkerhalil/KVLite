...
// IntroduceOptionalParameters.Global ReSharper disable MemberCanBeProtected.Global ReSharper
// disable InconsistentNaming

namespace PommaLabs.KVLite.Annotations
{
    /// <summary>
    ...
    ///   <see cref="System.ComponentModel.INotifyPropertyChanged"/> interface and this method is
    ///   used to notify that some property value changed
    /// </summary>
    /// <remarks>
    ...
    ///   &lt;= Input</item><item>Input ::= ParameterName: Value [, Input]*</item><item>Output ::=
    ///   [ParameterName: Value]* {halt|stop|void|nothing|Value}</item><item>Value ::= true | false
    ...
    ///   is on stack. If the parameter is a delegate, indicates that delegate is executed while the
    ///   method is executed. If the parameter is an enumerable, indicates that it is enumerated
    ...
    /// <summary>
    ///   ASP.NET MVC attribute. Indicates that a parameter is an MVC Master. Use this attribute for
    ///   custom wrappers similar to <c>System.Web.Mvc.Controller.View(String, String)</c>
    /// </summary>
    [AttributeUsage(AttributeTargets.Parameter)]
    ...
    /// <summary>
    ///   ASP.NET MVC attribute. If applied to a parameter, indicates that the parameter is an MVC
    ///   view. If applied to a method, the MVC view name is calculated implicitly from the context.
    ///   Use this attribute for custom wrappers similar to <c>System.Web.Mvc.Controller.View(Object)</c>
    /// </summary>
    [AttributeUsage(AttributeTargets.Parameter | AttributeTargets.Method)]
